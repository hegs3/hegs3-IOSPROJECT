...
open class ActionButton: NSObject {
    ...
    open var backgroundColor: UIColor = UIColor.init(red: 75/255.0, green: 134/255.0, blue: 175/255.0, alpha: 1) {
    ...
    open var backgroundColorSelected: UIColor = UIColor.init(red: 75/255.0, green: 134/255.0, blue: 175/255.0, alpha: 1)
    ...
    public init(attachedToView view: UIView, items: [ActionButtonItem]?) {
        ...
        self.floatButton.setTitle(nil, for: UIControl.State())
        self.floatButton.setImage(UIImage(named: "setting.png"), for: UIControl.State())
...
//        self.contentView.addSubview(self.blurVisualEffect)
        self.contentView.backgroundColor = UIColor(red: 238/255.0, green: 238/255.0, blue: 238/255.0, alpha: 0.5)
        
        let tap = UITapGestureRecognizer(target: self, action: #selector(ActionButton.backgroundTapped(_:)))
        self.contentView.addGestureRecognizer(tap)
        
        self.parentView.backgroundColor = UIColor(red: 238/255.0, green: 238/255.0, blue: 238/255.0, alpha: 1)
    ...
    open func setTitle(_ title: String?, forState state: UIControl.State) {
        floatButton.setImage(UIImage(named: "setting.png"), for: state)
